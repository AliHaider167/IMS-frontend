      ...
      <div className="flex items-center gap-3">
        <div className="bg-gradient-to-br from-blue-500 to-blue-400 rounded-xl p-2 flex items-center justify-center">
          <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
            ...
            <path
              d="M12 7a3 3 0 0 1 3 3v1a3 3 0 0 1-6 0v-1a3 3 0 0 1 3-3Zm0 8c-3.31 0-6 1.34-6 3v1h12v-1c0-1.66-2.69-3-6-3Z"
              fill="#007bff"
            />
          </svg>
        </div>
        <div>
          ...
          <p className="text-gray-500 text-sm xl:text-base">Welcome, admin</p>
        </div>
      </div>
